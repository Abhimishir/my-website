        ...
        3651: (e, t, n) => {
            ...
            class BaseFilterFrontendModule extends elementorModules.Module {
                ...
                getFetchArgumentsForLoopUpdate(e, t) {
                    ...
                    return elementorFrontend.isEditMode() && elementorPro.config.loopFilter ? (elementorPro.config.loopFilter.nonce && (s.headers["X-WP-Nonce"] = elementorPro.config.loopFilter.nonce), s) : s;
                }
                ...
                consolidateFilters(e) {
                    ...
                    for (const e in t) {
                        ...
                        0 !== r.terms.length && (n[o] || (n[o] = {}), n[o][r.selectedTaxonomy] || (n[o][r.selectedTaxonomy] = []), !r.terms || n[o][r.selectedTaxonomy].terms && n[o][r.selectedTaxonomy].terms.includes(r.terms) || (n[o][r.selectedTaxonomy] = {
                            ...
                            logicalJoin: r.logicalJoin ? "AND" : r.logicalJoin
                        }))
                    }
